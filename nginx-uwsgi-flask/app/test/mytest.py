...
def dare_api_test():
    print('Creating Workspace: '+sys.argv[3]+' ......')
    # API "workflow" preprocess
    workspace_url=create_workspace("", sys.argv[3], "")
    print('Creating PE:'+sys.argv[3]+' in Workspace: '+sys.argv[3]+'......')
    pe_url=create_pe(desc="", name=sys.argv[3], conn=[], pckg=sys.argv[3],
    ...
    create_peimpl(desc="", code=open('mySplitMerge.py').read(),
                                  parent_sig=pe_url, pckg=sys.argv[3],
                                  name=sys.argv[3], workspace=workspace_url,
                                  clone="")
    ...
    print('Submit correct Dispel4py run of PE '+sys.argv[3]+' .....')
    # DARE API demo
    submit_d4p(impl_id=1, pckg=sys.argv[3], workspace_id=1, pe_name=sys.argv[3],
